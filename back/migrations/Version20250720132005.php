 ...
 */
final class Version20250720132005 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE Likes_student (id_likes_student INT AUTO_INCREMENT NOT NULL, liked_at DATETIME NOT NULL, student_id INT DEFAULT NULL, company_id INT DEFAULT NULL, job_id INT DEFAULT NULL, INDEX IDX_B6E48834CB944F1A (student_id), INDEX IDX_B6E48834979B1AD6 (company_id), INDEX IDX_B6E48834BE04EA9 (job_id), PRIMARY KEY(id_likes_student)) DEFAULT CHARACTER SET utf8mb4
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE Matches (id_matches INT AUTO_INCREMENT NOT NULL, matched_at DATETIME NOT NULL, is_valid TINYINT(1) NOT NULL, is_contacted TINYINT(1) NOT NULL, student_id INT DEFAULT NULL, company_id INT DEFAULT NULL, job_id INT DEFAULT NULL, INDEX IDX_C99B2C26CB944F1A (student_id), INDEX IDX_C99B2C26979B1AD6 (company_id), INDEX IDX_C99B2C26BE04EA9 (job_id), PRIMARY KEY(id_matches)) DEFAULT CHARACTER SET utf8mb4
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE Users (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, role VARCHAR(255) NOT NULL, reset_password VARCHAR(255) DEFAULT NULL, reset_password_requested_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4
        SQL);
        $this->addSql(<<<'SQL'
