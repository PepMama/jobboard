 ...
 */
final class Version20250511162508 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Companies (id_company INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, phone_number VARCHAR(20) NOT NULL, website VARCHAR(255) DEFAULT NULL, linkedin VARCHAR(255) DEFAULT NULL, logo VARCHAR(255) DEFAULT NULL, industry VARCHAR(255) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, address LONGTEXT DEFAULT NULL, postal_code VARCHAR(10) DEFAULT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, user_id INT NOT NULL, UNIQUE INDEX UNIQ_B52899A76ED395 (user_id), PRIMARY KEY(id_company)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE Competencies (id_competency INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id_competency)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE Languages (id_language INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id_language)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE Likes_offer (id_like_offer INT AUTO_INCREMENT NOT NULL, liked_at DATETIME NOT NULL, student_id INT DEFAULT NULL, job_id INT DEFAULT NULL, INDEX IDX_13B6A46FCB944F1A (student_id), INDEX IDX_13B6A46FBE04EA9 (job_id), PRIMARY KEY(id_like_offer)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE Likes_student (id_likes_student INT AUTO_INCREMENT NOT NULL, liked_at DATETIME NOT NULL, student_id INT DEFAULT NULL, company_id INT DEFAULT NULL, INDEX IDX_B6E48834CB944F1A (student_id), INDEX IDX_B6E48834979B1AD6 (company_id), PRIMARY KEY(id_likes_student)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE Student_languages (proficiency ENUM(\'Beginner\', \'Intermediate\', \'Advanced\', \'Fluent\'), student_id INT NOT NULL, language_id INT NOT NULL, INDEX IDX_E91CA003CB944F1A (student_id), INDEX IDX_E91CA00382F1BAF4 (language_id), PRIMARY KEY(student_id, language_id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE Students (id_student INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, phone_number VARCHAR(255) NOT NULL, age INT DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, address LONGTEXT DEFAULT NULL, postal_code VARCHAR(10) DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, description LONGTEXT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, linkedin VARCHAR(255) DEFAULT NULL, github VARCHAR(255) DEFAULT NULL, cv VARCHAR(255) DEFAULT NULL, user_id INT NOT NULL, UNIQUE INDEX UNIQ_5D1FEFE4A76ED395 (user_id), PRIMARY KEY(id_student)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE Student_competencies (student_id INT NOT NULL, competency_id INT NOT NULL, INDEX IDX_F1A9ADC4CB944F1A (student_id), INDEX IDX_F1A9ADC4FB9F58C (competency_id), PRIMARY KEY(student_id, competency_id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE Users (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, role VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('ALTER TABLE Companies ADD CONSTRAINT FK_B52899A76ED395 FOREIGN KEY (user_id) REFERENCES Users (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE Likes_offer ADD CONSTRAINT FK_13B6A46FCB944F1A FOREIGN KEY (student_id) REFERENCES Students (id_student) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE Likes_offer ADD CONSTRAINT FK_13B6A46FBE04EA9 FOREIGN KEY (job_id) REFERENCES Job_offers (id_job) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE Students ADD CONSTRAINT FK_5D1FEFE4A76ED395 FOREIGN KEY (user_id) REFERENCES Users (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE Companies DROP FOREIGN KEY FK_B52899A76ED395');
        ...
        $this->addSql('ALTER TABLE Likes_offer DROP FOREIGN KEY FK_13B6A46FCB944F1A');
        $this->addSql('ALTER TABLE Likes_offer DROP FOREIGN KEY FK_13B6A46FBE04EA9');
        ...
        $this->addSql('ALTER TABLE Students DROP FOREIGN KEY FK_5D1FEFE4A76ED395');
        ...
        $this->addSql('DROP TABLE Likes_offer');
