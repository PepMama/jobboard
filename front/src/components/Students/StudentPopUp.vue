      ...
      <section class="section links">
        ...
        <ul class="links-list">
          <li v-if="student.LinkedIn">
            <a :href="student.LinkedIn" class="link">LinkedIn</a>
          </li>
          <li v-if="student.Github">
            <a :href="student.Github" class="link">GitHub</a>
          </li>
          <li v-if="student.portfolio">
            <a :href="student.portfolio" class="link">Portfolio</a>
          </li>
          <li v-if="student.CV">
            <a :href="`https://localhost:8000/uploads/cvs/${student.CV}`" class="link">
