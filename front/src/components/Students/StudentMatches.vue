            ...
            <div class="card bg-white shadow-sm h-100">
              <div class="card-body d-flex flex-column">
                <div class="d-flex align-items-center mb-3">
                  <img :src="company.company.logo || '/src/assets/avatar-defaut.jpg'"
                    :alt="`${company.company.name} logo`" class="rounded-circle me-3" width="60" height="60"
                    style="object-fit: cover" />
                  <div class="flex-grow-1">
                    <h5 class="mb-1">{{ company.job.title }}</h5>
                    <p class="text-muted mb-0">{{ company.company.name }} – {{ company.job.city }}</p>
                ...
                <p v-if="company.job.description" class="text-muted small mb-3">
                  {{ company.job.description?.substring(0, 100) }}{{ company.job.description?.length > 100 ? '...' : ''
                  }}
                </p>
                ...
                <div class="mt-auto">
                  <div class="d-flex gap-2 mb-2">
                    <a v-if="company.company.linkedin" :href="company.company.linkedin" target="_blank"
                      class="btn btn-outline-primary btn-sm">
                      LinkedIn
                    </a>
                    <a v-if="company.company.website" :href="company.company.website" target="_blank"
